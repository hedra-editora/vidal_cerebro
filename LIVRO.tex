\documentclass[semcabeco,compontinhos,showtrims,trimframe,11pt,conselho,spreadimages]{memoir}

\usepackage[16x23n-1]{hedraoptions} %% << %%%%%%%%%%%%%%%%
...
\hyphenation{Brownlow}
\hyphenation{Leary}
\hyphenation{bio-po-lí-ti-ca}
\hyphenation{bio-po-lí-ti-cas}
\hyphenation{neu-ro-bio-ló-gi-ca}
\hyphenation{Hastings}
\hyphenation{Center}
\hyphenation{au-to-ima-gem}
\hyphenation{Eagleton}
\hyphenation{hipo-meta-bo-lismo}
