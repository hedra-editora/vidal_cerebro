...
relatos que teriam desconectado as \enlargethispage{\textheight}ciências humanas da realidade
...
tarefa de interesse.}\footnote{Figura extraída de Roskies (2010). Cortesia
...
64\% foram utilizadas no estudo de \versal{IRM}f.}\footnote{Figura extraída de Di Dio,
...
apoiam, em vez de caracterizá"-lo como \enlargethispage{\textheight} um choque de grupos homogêneos
